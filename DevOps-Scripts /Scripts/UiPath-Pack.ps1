...
$process = Start-Process cmd -ArgumentList "/c $uipathCLI package pack `"$Project_Path`"  -o `"$Output`" --version `"$formattedDate`" --libraryOrchestratorUrl `"$libraryOrchestratorUrl`" --libraryOrchestratorTenant `"$libraryOrchestratorTenant`" --libraryOrchestratorAccountForApp `"$libraryOrchestratorAccountForApp`" --libraryOrchestratorApplicationId `"$libraryOrchestratorApplicationId`" --libraryOrchestratorApplicationSecret `"$libraryOrchestratorApplicationSecret`" --libraryOrchestratorApplicationScope `"$libraryOrchestratorApplicationScope`"" -NoNewWindow -PassThru -Wait
